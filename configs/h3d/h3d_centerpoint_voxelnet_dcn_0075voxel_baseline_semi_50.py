...
nsweeps = 10
data_root = "/working_dir/h3d_data/icra_bin_50"

db_sampler = dict(
    type="GT-AUG",
    enable=False,
    db_info_path="/working_dir/h3d_data/icra_bin_50/h3d_all_dbinfos_train.pkl",
    sample_groups=[
        dict(Car=2),
        dict(Pedestrian=2),
        {'Other vehicle':6},
...
train_anno = "/working_dir/h3d_data/icra_bin_50/h3d_all_infos_train.pkl"
val_anno = "/working_dir/h3d_data/icra_bin_50/h3d_all_infos_val.pkl"
test_anno = "/working_dir/h3d_data/icra_bin_50/h3d_all_infos_test.pkl"
